<?php
class Exdos_Sidebar_Post_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'exdos_sidebar_post_widget',
            __('Exdos Sidebar Post', 'text_domain'),
...
function register_exdos_sidebar_post_widget() {
    register_widget('Exdos_Sidebar_Post_Widget');
}
add_action('widgets_init', 'register_exdos_sidebar_post_widget');
